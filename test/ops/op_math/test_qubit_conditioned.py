...
class TestGraphDecomposition:
    ...
    def test_qcondf_to_cr(self, graph_enabled, device):
    ...
    @pytest.mark.parametrize("device", ("bosonicqiskit.hybrid", "qcvdv.hybrid"))
    def test_multi_qcondf_to_cr(self, graph_enabled, device):
        dev = qml.device(device, max_fock_level=8)
    ...
    @pytest.mark.parametrize("device", ("bosonicqiskit.hybrid", "qcvdv.hybrid"))
    def test_ctrlf_to_cr(self, graph_enabled, device):
        dev = qml.device(device, max_fock_level=8)
    ...
    @pytest.mark.parametrize("device", ("bosonicqiskit.hybrid", "qcvdv.hybrid"))
    def test_multicondf_to_cr(self, graph_enabled, device):
        dev = qml.device(device, max_fock_level=8)
    ...
    @pytest.mark.parametrize("device", ("bosonicqiskit.hybrid", "qcvdv.hybrid"))
    def test_condbs_to_cbs(self, graph_enabled, device):
        dev = qml.device(device, max_fock_level=8)
    ...
    @pytest.mark.parametrize("device", ("bosonicqiskit.hybrid", "qcvdv.hybrid"))
    def test_multicondbs_to_cbs(self, graph_enabled, device):
        dev = qml.device(device, max_fock_level=8)
    ...
    @pytest.mark.parametrize("device", ("bosonicqiskit.hybrid", "qcvdv.hybrid"))
    def test_cond_cd(self, graph_enabled, device):
        dev = qml.device(device, max_fock_level=8)
    ...
    @pytest.mark.parametrize("device", ("bosonicqiskit.hybrid", "qcvdv.hybrid"))
    def test_cond_pow_cr(self, graph_enabled, device):
        dev = qml.device(device, max_fock_level=8)
    ...
    @pytest.mark.parametrize("device", ("bosonicqiskit.hybrid", "qcvdv.hybrid"))
    def test_pow_adj_cr(self, graph_enabled, device):
        dev = qml.device(device, max_fock_level=8)
    ...
    @pytest.mark.parametrize("device", ("bosonicqiskit.hybrid", "qcvdv.hybrid"))
    def test_pow_cond_cr(self, graph_enabled, device):
        dev = qml.device(device, max_fock_level=8)
